...
class _LoginPageState extends State<LoginPage>{
  ...
  Widget build(BuildContext context) {
    ...
    // IconData icon = ImageIcon(AssetImage("assets/images/mmdu.png")) as IconData;
    return Scaffold(
        ...
        child: Column(
          children: [
            Container(
              ...
              child: HeaderWidget(_headerHeight, true,Icons.verified_outlined), //let's create a common header widget
            ),
            SafeArea(
              child: Container( 
