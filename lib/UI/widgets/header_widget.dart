// This widget will draw header section of all pages. Which you will get with the project source code.
        ...
        children: [
          ClipPath(
            ...
            clipper: new ShapeClipper(
                [
                  Offset(width / 1, _height),
                  Offset(width / 1 * 1, _height - 60),
                  Offset(width / 1 * 1, _height + 20),
          ...
          ClipPath(
            ...
            clipper: new ShapeClipper(
                [
                  Offset(width / 1, _height + 5),
                  Offset(width / 1 * 1, _height - 60),
                  Offset(width / 1 * 1, _height - 60),
                  Offset(width, _height - 5)
                ]
            ),
          ),
          ClipPath(
            ...
            clipper: new ShapeClipper(
                [
                  Offset(width / 1, _height),
                  Offset(width / 1, _height - 40),
                  Offset(width / 1 * 1, _height - 80),
